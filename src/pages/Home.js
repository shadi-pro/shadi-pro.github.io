  ...
  const projects = [
    {
      ...
      githubUrl: "https://github.com/shadi-pro/flutter-market-apps-catalog/tree/main/vaultfin_flutter_template",
      liveDemo: null,
    ...
    },
    {
      ...
      githubUrl: "https://github.com/shadi-pro/flutter-market-apps-catalog/tree/main/atlas_sky_flutter_app",
      liveDemo: null,
    ...
    },
    {
      ...
      githubUrl: "https://github.com/shadi-pro/flutter-market-apps-catalog/tree/main/ecommerce_ui_app",
      liveDemo: null,
    ...
    },
    {
      ...
      githubUrl: "https://github.com/shadi-pro/flutter-market-apps-catalog/tree/main/task_manager_app",
      liveDemo: null,
    ...
    },
    {
      ...
      githubUrl: "https://github.com/shadi-pro/flutter-market-apps-catalog/tree/main/social_media_clone_app",
      liveDemo: null,
          ...
          <Container>
            <Row className="align-items-center">
              <Col lg={6}>
                ...
                {/* FIXED: Button container with flex-wrap for mobile */}
                <div className="mt-4 d-flex flex-wrap gap-2">
                  <Button variant="primary" size="lg" className="btn-custom" href="#projects">
                    <FaRocket className="me-2" /> View Projects
                  </Button>
                  <ResumeButton />
                  <Button variant="outline-light" size="lg" className="btn-custom" href="#contact">
                  ...
                  {filteredProjects.map((project, index) => (
                    <Col md={6} xl={4} key={project.id}>
                      <AnimatedCard index={index}>
                        <Card className="project-card-compact h-100">
      ...
      <AnimatedSection delay={0.3}>
        <section className="skills-section py-5" id="skills">
          <Container>
            ...
            {/* ===== State Management Skills Section ===== */}
              ...
              <Col lg={8}>
                ...
                <div className="about-content">
                  <p className="lead mb-4">
                    Hello! I'm <strong>Shadi Sayed</strong>, a <strong>Full Stack Developer</strong> specializing in <strong className="text-primary">Flutter</strong> with <strong>{projects.length}+ production mobile apps</strong> in finance, e-commerce, social media, and more.
                  </p>
                  
                  {/* ===== MERN Stack Experience Badge ===== */}
                  <div className="mern-experience-badge mb-4 p-3 bg-white rounded-3 shadow-sm">
                    <div className="d-flex align-items-center flex-wrap gap-3">
                      <div className="mern-icon-wrapper">
                        <span className="mern-stack-icons">
                          <span className="mern-icon">M</span>
                          <span className="mern-icon">E</span>
                          <span className="mern-icon">R</span>
                          <span className="mern-icon">N</span>
                        </span>
                      </div>
                      <div className="flex-grow-1">
                        <h5 className="mb-1">
                          <span className="text-primary">MERN Stack</span> Full Stack Web Developer
                        </h5>
                        <p className="mb-2 text-muted">
                          Experienced in building responsive web applications with MongoDB, Express.js, React, and Node.js
                        </p>
                        <div className="d-flex flex-wrap gap-2 mb-2">
                          <Badge bg="light" text="dark" className="mern-tech-badge">MongoDB</Badge>
                          <Badge bg="light" text="dark" className="mern-tech-badge">Express.js</Badge>
                          <Badge bg="light" text="dark" className="mern-tech-badge">React.js</Badge>
                          <Badge bg="light" text="dark" className="mern-tech-badge">Node.js</Badge>
                          <Badge bg="light" text="dark" className="mern-tech-badge">REST APIs</Badge>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <p className="mb-3">
                    Currently focused on <strong>Flutter development</strong> while leveraging my <strong>MERN stack background</strong> to build full-stack mobile applications with robust backend architectures. My web development experience gives me a unique advantage in creating complete, scalable solutions.
                  </p>
                  
                  {/* ===== External Portfolio Button ===== */}
                  <div className="d-flex align-items-center justify-content-between flex-wrap gap-3 mt-4 p-3 bg-primary bg-opacity-10 rounded-3">
                    <div>
                      ...
                      <p className="small text-muted mb-0">
                        Explore my MERN stack projects, React applications, and full-stack web development work
                      </p>
                    </div>
                    <Button 
                      variant="primary" 
                      className="btn-custom px-4"
                      href="https://shadi-webdev.web.app/" 
                      target="_blank"
                  ...
                  <div className="row mt-4">
                    <div className="col-md-6">
                      <ul className="list-unstyled">
                        <li className="mb-2"><FaMobileAlt className="text-primary me-2" /> <strong>Mobile (Primary):</strong> Flutter, GetX, BLoC, Provider</li>
                        <li className="mb-2"><FaCode className="text-primary me-2" /> <strong>Web (Secondary):</strong> MERN Stack (React, Node.js, MongoDB)</li>
                      </ul>
                    </div>
                    <div className="col-md-6">
                      <ul className="list-unstyled">
                        <li className="mb-2"><FaServer className="text-primary me-2" /> <strong>Backend:</strong> Node.js, Express, Firebase, REST APIs</li>
                        <li className="mb-2"><FaDatabase className="text-primary me-2" /> <strong>Databases:</strong> MongoDB, Firebase, MySQL</li>
                      </ul>
                    </div>
                  </div>
                  
                  {/* Experience Timeline Summary */}
                  <div className="experience-summary mt-3">
                    <p className="mb-1">
                      <Badge bg="success" className="me-2">🎯 Current</Badge> 
                      <strong>Flutter Developer</strong> - Building cross-platform mobile apps
                    </p>
                    <p className="mb-0">
                      <Badge bg="info" className="me-2">📱 Past</Badge> 
                      <strong>MERN Stack Developer</strong> - Full-stack web applications
                    </p>
                  </div>
                </div>
              </Col>
        ...
        <Container>
          <Row className="align-items-center">
            ...
            <Col lg={6} className="text-lg-end">
              ...
              <div className="mt-3">
                <Link to="/terms-and-conditions" className="text-white-50 text-decoration-none small">
                  Terms & Conditions
                </Link>
              ...
              <div className="social-icons mb-4">
                ...
                <a href="mailto:shadisayed.6890@gmail.com" className="text-white"><FaEnvelope size={20} /></a>
              </div>
